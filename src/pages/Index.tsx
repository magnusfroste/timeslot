  ...
  return (
    <div className="min-h-screen aurora-bg noise overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 py-16 md:py-24">
        ...
        {/* Benefits Section */}
        <div
          className="glass-strong rounded-3xl p-8 md:p-12 max-w-4xl mx-auto animate-fade-in-up"
          style={{ animationDelay: "0.4s" }}
        >
          <h2 className="text-2xl md:text-3xl font-bold text-center text-foreground mb-10">Why Choose Timeslot?</h2>
